					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item <?php echo $signIn??NULL;?>">
							...
							<?php }elseif (isset($_SESSION['user']) and !isset($_SESSION['admin'])) {?>
								<a class="nav-link" href="<?php echo urlUser('index.php')?>">My account <i class="fas fa-user-circle" style="font-size: 1.3rem;"></i></a>
							<?php }elseif (!isset($_SESSION['user']) and isset($_SESSION['admin'])) { ?>
								<a class="nav-link" href="<?php echo url('index.php')?>">ADMIN <i class="fas fa-user-cog"></i></a>
							<?php }?>
						</li>
