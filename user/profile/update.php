...
if ($_SESSION['user']['id'] == $id) {
    $sqlgov = "SELECT * FROM `user_detail` WHERE governorate != ''";
    $opgov  = mysqli_query($conn,$sqlgov);
    $sqlcity = "SELECT * FROM `user_detail` WHERE city != ''";
...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(count($errors) > 0){
        ...
        $sql = "UPDATE users SET firstname = '$fusername', lastname = '$lusername', email = '$userEmail' WHERE id =".$id;
        $op  = mysqli_query($conn,$sql);
    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <?php 
                PrintMessages('Update profile',$_SESSION['del_flag']);
                ?>
                </li>
            </ol>
            <!-- create form  -->
